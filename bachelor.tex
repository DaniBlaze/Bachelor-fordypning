...
\pagenumbering{roman}
\chapter*{Forord}
\input{kapittel/forord}

\chapter*{Sammendrag}
\input{kapittel/sammendrag}
...
\setcounter{page}{1}
\chapter{Innledning}
\input{kapittel/innledning}

\chapter{ROCKWOOL International og byggisolasjonsbransjen}
\input{kapittel/byggisolasjonsbransjen}

\chapter{Beslutningsalternativer}
\input{kapittel/beslutningsalternativer}

\chapter{Metode}
\input{kapittel/metode}

\chapter{Teori}
\input{kapittel/teori}

\chapter{Makroøkonomiske forhold}
\input{kapittel/makroforhold}

\chapter{Spesifisering av data}
\input{kapittel/spesifisering}

\chapter{Lønnsomhetsberegning - netto nåverdi}
\input{kapittel/lonnsomhet}

\chapter{Sensitivitetsanalyse}
\input{kapittel/sensitivitetsanalyse}

\chapter{Drøfting}
\input{kapittel/drofting}

\chapter{Kritikk av oppgaven}
\input{kapittel/kritikk}

\chapter{Konklusjon}
\input{kapittel/konklusjon}
...
\input{appendiks/rockwoolbetaregresjon}

\chapter{Rockwool kontantstrømmer}
\input{appendiks/kontantstrommer}

\chapter{Logg}
\input{appendiks/logg}
\end{document}
